...
<span id="title-text"> NetLicensing Wiki : Licensee Secret </span>
==================================================================

Created by <span class="author"> Konstantin Korotkov</span>, last
modified by <span class="editor"> Alexey Averikhin</span> on 15-12-2017

-   [Introduction](#LicenseeSecret-Introduction)
-   [Validation flow](#LicenseeSecret-Validationflow)
-   [Examples](#LicenseeSecret-Examples)
    -   [Predefined mode](#LicenseeSecret-Predefinedmode)
    -   [Client mode](#LicenseeSecret-Clientmode)
