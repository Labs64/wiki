...
<span id="title-text"> NetLicensing Wiki : Product Services </span>
===================================================================
...
<p>licenseeSecretMode (enum) - Licensee secret mode for product. Optional.</p>
...
<td><p>200 - Successful request<br />
400 - Malformed or illegal request<br />
<span>402 - Quota exceeded</span><br />
403 - Access is denied<br />
404 - Resource not found<br />
500 - Internal service error</p></td>
</tr>
